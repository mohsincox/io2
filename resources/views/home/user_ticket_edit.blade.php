                    ...
                    <div class="box-body no-padding">
                        ...
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            <li style="padding: 5px;">
                                ...
                                </span> Price: <b>{{ $ticket->total_price }} Taka</b>
                            </li>
                        ...
                        <div class="box box-success">
                            ...
                            <div class="box-body">
                                {!! Form::model($ticket, ['url' => "order/user/$ticket->id", 'method' => 'put', 'class' => 'form-horizontal']) !!} 
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12">
                                        <div class="form-group {{ $errors->has('delivery_status_blank') ? 'has-error' : ''}}">
                                            <div class="col-xs-12 col-sm-12">
                                                {!! Form::select('delivery_status_blank', $dsList, null, ['class' => 'form-control','placeholder' => 'Please Select a Delivery Status']) !!}
                                                <span class="text-danger">
                                                    {{ $errors->first('delivery_status_blank') }}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
